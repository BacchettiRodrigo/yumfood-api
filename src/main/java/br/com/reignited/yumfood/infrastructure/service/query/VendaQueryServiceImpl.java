package br.com.reignited.yumfood.infrastructure.service.query;

import br.com.reignited.yumfood.domain.filter.VendaDiariaFilter;
import br.com.reignited.yumfood.domain.model.Pedido;
import br.com.reignited.yumfood.domain.model.StatusPedido;
...
public class VendaQueryServiceImpl implements VendaQueryService {
    ...
    public List<VendaDiaria> consultarVendasDiarias(VendaDiariaFilter filtro, String timeOffSet) {
        ...
        var functionDateDataCriacao = builder.function("date", LocalDate.class, functionConverTzDataCriacao);
